<?php
// HTTP
define('HTTP_SERVER', 'http://store.perfumena.com/admin/');
define('HTTP_CATALOG', 'http://store.perfumena.com/');

// HTTPS
define('HTTPS_SERVER', 'https://store.perfumena.com/admin/');
define('HTTPS_CATALOG', 'https://store.perfumena.com/');
...
define('DB_PASSWORD', 'OpenCart!23$');
